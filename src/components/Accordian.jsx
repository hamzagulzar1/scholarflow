		...
		<div id="accordion-open" data-accordion="open">
			<h2 id="accordion-open-heading-1">
				<button
					...
					onClick={toggleTab1}
				>
					<span className="flex items-center">Bachelors Programs</span>
					<svg
						data-accordion-icon
			...
			<h2 id="accordion-open-heading-2">
				<button
					...
					onClick={toggleTab2}
				>
					<span className="flex items-center">Masters Programs</span>
					<svg
						data-accordion-icon
						className="w-3 h-3 rotate-180 shrink-0"
						aria-hidden="true"
			...
			<h2 id="accordion-open-heading-3">
				<button
					...
					onClick={toggleTab3}
				>
					<span className="flex items-center">PHD Programs</span>
					<svg
						data-accordion-icon
						className="w-3 h-3 rotate-180 shrink-0"
						aria-hidden="true"
